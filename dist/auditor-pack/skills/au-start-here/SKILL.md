...
- Turning figures into something a person reads → `au-build-report`
- Anything touching customer records → `au-handle-customer-data`. Route here for the RULES even when
