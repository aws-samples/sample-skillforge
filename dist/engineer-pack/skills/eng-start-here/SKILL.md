...
- Getting figures out of the warehouse → `eng-query-warehouse`
- Turning figures into something a person reads → `eng-build-report`
- Anything touching customer records → `eng-handle-customer-data`. Route here for the RULES even when
