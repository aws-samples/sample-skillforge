...
- Turning figures into something a person reads → `pm-build-report`
- Anything touching customer records → `pm-handle-customer-data`. Route here for the RULES even when
