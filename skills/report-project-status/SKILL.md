...
1. Reuse the outcomes and milestones from `plan-project-delivery`.
...
Use `build-report` for the final narrative. Never convert “work started” or “most tasks complete”
