...
6. Identify customer-data needs early and use `handle-customer-data` before requesting an extract.
...
`build-report` and preserve the source and date of each status claim.
